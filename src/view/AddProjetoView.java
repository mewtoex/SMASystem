...
public class AddProjetoView extends javax.swing.JFrame {
    ...
    private void jbGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGravarActionPerformed
            ...
            try {
                ...
                AssistidosController.getInstance().persitirNxn(getDados(),projeto());

                JOptionPane.showMessageDialog(this, "Assistido Adiconadoa no Projeto");
                //Fecha a tela
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProjetoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddProjetoView().setVisible(true);
            }
        });
    }
    ...
    public void setDados(Assistidos l) {
