...
public class AmparatosAView extends javax.swing.JFrame {

   
    public AmparatosAView() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmparatosAView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmparatosAView().setVisible(true);
            }
        });
    }
    ...
    public void Colaboraçao(Projeto m){
        ...
        List<Assistidos> h = m.getAmparatos();
