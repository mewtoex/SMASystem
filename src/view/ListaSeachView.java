...
public class ListaSeachView extends javax.swing.JFrame {

    public String mesagen;

    public ListaSeachView() {
    ...
    private void initComponents() {
        ...
        jbBuscar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jbBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/ImgNovo/Thumbs Up_32px.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaSeachView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaSeachView().setVisible(true);
            }
        });
    }
    ...
    public Long pro() {
        ...
        Projeto p = ProjetoController.getInstance().buscarNome(doa);
        Long id = p.getId();
