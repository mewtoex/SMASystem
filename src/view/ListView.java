...
public class ListView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de Prensença");
    ...
    public void Colaboraçao(Long d, String f) {
        List<Lista> lt = ListaController.getInstance().buscarPro(d, f);
        List<Lista> b = lt;
        ...
        for (Lista i : b) {
            ...
            JCheckBox bn = new  JCheckBox();
            modelo.addRow(new Object[]{i.getAss().getNome(), i.getPro().getNome(), i.getData(), presenca});
        ...
        jtAtendente.getColumnModel().getColumn(1).setPreferredWidth(50);
        jtAtendente.getColumnModel().getColumn(2).setPreferredWidth(50);
