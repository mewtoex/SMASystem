...
public class Colaboracao1View extends javax.swing.JFrame {


    public Colaboracao1View() {
    ...
    private void jbGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGravarActionPerformed
            ...
            try {
                ...
                ProjetoController.getInstance().persitirNxn(getDados(),Voluntario());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Colaboracao1View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Colaboracao1View().setVisible(true);
            }
        });
    }
    ...
    public Long Voluntario() {
        Long n;
        Voluntario p;
        p= VoluntarioController.getInstance().BuscaNome(String.valueOf(JcbProjeto.getSelectedItem()));
        n=p.getId();
        return n;
    ...
    public void LoadDoa() {
        ...
        for (Voluntario p : VoluntarioController.getInstance().BuscaTodos()) {
